...
function App() {
  ...
  return (
    <div className='page'>
      ...
      <Footer />
      <PopupWithForm name='edit-author' title='Редактировать профиль' isOpen={isEditProfilePopupOpen} onClose={closeAllPopups}>
      ...
      <PopupWithForm name='view-card' title='Вы уверены?'></PopupWithForm>
